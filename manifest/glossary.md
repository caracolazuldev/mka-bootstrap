...
| Term | Definition |
|------|------------|
| **Milestone (M-###)** | Bite-sized developer assignment on ROADMAP.md; objectively verifiable; ≤ one day of work |
| **Stage marker** | ROADMAP `# ── Stage ──` divider; milestones belong to the stage above |
